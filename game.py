...
def gestion_interact_socket(HOST, PORT, NUMBER_OF_PLAYERS):
    print("")
    print("lancement du thread d'interaction avec succès")
    print("")
...
def main():
    ...
    #récupération du pid et stockage en shared memory
    process = multiprocessing.current_process()
    shared_memory.update({"mainpid":process.pid})
    
    #initialisation des interactions game-player dans un thread
